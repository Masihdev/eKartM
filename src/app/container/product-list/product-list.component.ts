...
export class ProductListComponent {
  ...
  totalProductInStock: number = this.products.filter(product => product.is_in_inventory === true).length;
  totalProductOutOfStock: number = this.products.filter(product => product.is_in_inventory === false).length;
